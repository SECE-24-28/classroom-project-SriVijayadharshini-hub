...
export default function RechargeForm({ onRecharge, presetAmount, presetOperator }) {
  ...
  return (
    <div className="space-y-6 max-w-2xl mx-auto">
      ...
      <button
        ...
        disabled={loading}
        className="w-full bg-gradient-to-r from-gray-700 to-gray-800 text-white p-4 rounded-xl font-bold text-lg hover:from-gray-800 hover:to-gray-900 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 shadow-lg hover:shadow-xl border border-gray-600"
      >
        {loading ? (
